...
import com.example.quekyufei.studyspaces.database.sqlAsset.SQLiteAssetHelper.SQLiteAssetException;
...
class VersionComparator implements Comparator<String> {
    ...
    private static final String TAG = com.example.quekyufei.studyspaces.database.sqlAsset.SQLiteAssetHelper.class.getSimpleName();
